...
def send_html_email(template_name, subject, from_email, recipients, context):
    ...
    msg = EmailMultiAlternatives(subject, text_content, from_email, recipients, headers={'Reply-To': reply_to_email })
