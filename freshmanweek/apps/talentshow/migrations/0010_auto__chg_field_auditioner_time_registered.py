...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Auditioner.time_registered'
        db.alter_column(u'talentshow_auditioner', 'time_registered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Auditioner.time_registered'
        db.alter_column(u'talentshow_auditioner', 'time_registered', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        u'talentshow.auditioner': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'Z2XZJSKCBUOS57E34Y899CKEQGYTCE'", 'unique': 'True', 'max_length': '40'}),
