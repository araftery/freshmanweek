...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AuditionSignUpReminder.created_at'
        db.alter_column(u'talentshow_auditionsignupreminder', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 11, 0, 0)))

    def backwards(self, orm):

        # Changing field 'AuditionSignUpReminder.created_at'
        db.alter_column(u'talentshow_auditionsignupreminder', 'created_at', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        u'talentshow.auditioner': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'94JDT3NC239JGEX7XJ2TJS47UAK1CU'", 'unique': 'True', 'max_length': '40'}),
