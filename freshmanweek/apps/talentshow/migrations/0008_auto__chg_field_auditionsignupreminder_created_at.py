...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AuditionSignUpReminder.created_at'
        db.alter_column(u'talentshow_auditionsignupreminder', 'created_at', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        u'talentshow.auditioner': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'NIZAKPWHRS0OVYGBISPZ2PO6C774KX'", 'unique': 'True', 'max_length': '40'}),
