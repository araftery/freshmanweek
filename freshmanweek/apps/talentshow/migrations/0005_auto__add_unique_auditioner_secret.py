...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Auditioner', fields ['secret']
        db.create_unique(u'talentshow_auditioner', ['secret'])


    def backwards(self, orm):
        # Removing unique constraint on 'Auditioner', fields ['secret']
        db.delete_unique(u'talentshow_auditioner', ['secret'])
    ...
    models = {
        u'talentshow.auditioner': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'default'", 'unique': 'True', 'max_length': '40'}),
